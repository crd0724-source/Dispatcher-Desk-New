    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 min-w-[240px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2 rounded-lg bg-slate-950 border border-slate-800 text-xs sm:text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors"
          />
          {filters.search && (
            <button
              type="button"
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="min-w-[140px]">
            <select
              ...
              className="w-full px-2.5 py-2 rounded-lg bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors cursor-pointer"
            >
      ...
      <div className="flex items-center justify-between text-xs text-slate-400 pt-1 border-t border-slate-800/60 font-mono">
        <div className="flex items-center gap-2">
          <span>
            Displaying <strong className="text-slate-100">{filteredLoadsCount}</strong> of{' '}
            <strong className="text-slate-100">{totalLoadsCount}</strong> loads
          </span>
          {activeFiltersCount > 0 && (
            <span className="text-[10px] px-2 py-0.5 rounded bg-sky-950/80 text-sky-300 border border-sky-800/50">
              Filtered View
            </span>
          )}
        </div>
